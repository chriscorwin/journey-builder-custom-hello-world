...
var primaryActivitiesAnimationDuration = 800;
var primaryActivitiesAnimationEasing = [800, 40];


var secondaryActivitiesAnimationDelay = (primaryActivitiesAnimationDuration / 4);
var secondaryActivitiesAnimationDuration = (primaryActivitiesAnimationDuration / 2);
...
var rpdShow = function rpdShow(el) {
	...
	if ($thisElement.length === 0) {
		...
		if ($thisElement.hasClass("activityBar") === true) {
			...
			// 	// Logs all the animated divs. 
			// 	complete: function(elements) {
			// 		console.log("fadeIn complete", elements);
			// 	}
			// });
			// $thisElement.removeClass("pleaseHide");
