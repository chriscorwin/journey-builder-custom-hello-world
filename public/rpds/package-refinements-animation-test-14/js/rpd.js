...
var slideJbDays = function slideJbDays() {
	...
	var excludeBarID, $theActivityBars;
	if( $(".activityBar:visible:not(." + passedElementName + ", ." + passedElementName + "StopsFor, .activityBar:visible:last)").last().length !== 0) {
		...
		$theActivityBars = $("#" + excludeBarID + ":visible, .activityBar:visible:not(." + passedElementName + ", ." + passedElementName + "StopsFor)");
	} else {
		$theActivityBars = $(".activityBar:visible:not(." + passedElementName + ", ." + passedElementName + "StopsFor)");
	}
