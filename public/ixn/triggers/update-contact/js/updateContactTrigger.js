	...
	connection.on('updateStep', function(step) {
        ...
        */
		...
		if (!value) {
			...
			$('#updateContactTriggerConfigError').html('<strong style="color: red;">You must enter something</strong>');
		} else {
			// Successful change
			...
			uiPayload = {
				options: data,
				description: 'This is a update contact trigger configuration instance.'
			};

			etPayload = {
				filter: '<FilterDefinition Source=\'updateContactNTO\'><ConditionSet Operator=\'AND\' ConditionSetName=\'Grouping\'><Condition ID=\'ece15cd0-8893-e311-b943-78e3b50b4f00\' isParam=\'false\' Operator=\'Equal\' conditionValid=\'1\'><Value><![CDATA[' + data.originEventStart + ']]></Value></Condition></ConditionSet></FilterDefinition>'
			};
...
FROM: https://jbprod.exacttargetapps.com/rest/v1/contact/definition/?oauth_token=NONE&_=1392167891474
{
    ...
    key: "updateContactNTO"
    name: "updateContactNTO"
    -attributes: [
        -{
